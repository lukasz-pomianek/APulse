...
dependencies {
    ...
    // Note: Full UI module temporarily unavailable
    // Core module provides all network capture functionality
...
// After
implementation("com.github.lukasz-pomianek.APulse:apulse-core:v1.0.15")
debugImplementation("com.github.lukasz-pomianek.APulse:app:v1.0.15")
