...
dependencies {
    ...
    implementation("com.github.lukasz-pomianek:apulse-core:v1.0.33")

    // Full UI module for debug interface (~2MB) - debug builds only
    debugImplementation("com.github.lukasz-pomianek:apulse:v1.0.33")
    // Optional: Ktor plugin
    debugImplementation("com.github.lukasz-pomianek:apulse-ktor:v1.0.33")
